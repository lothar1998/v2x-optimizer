...
//go:generate mockgen --build_flags=-mod=mod -destination=performance/optimizer/optimizer.go -package=mocks github.com/lothar1998/v2x-optimizer/internal/performance/optimizer IdentifiableCacheableOptimizer
