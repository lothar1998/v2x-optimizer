...
// Source: github.com/lothar1998/v2x-optimizer/pkg/optimizer (interfaces: CustomOptimizer)
...
// MockOptimizer is a mock of CustomOptimizer interface.
...
func (m *MockOptimizer) Optimize(arg0 *data.Data) (*optimizer.Result, error) {
	m.ctrl.T.Helper()
